...
use crate::poseidon::common::matrix::{compute_optimized_matrixes, mmul_assign, try_inverse};
use crate::poseidon::common::params::InnerHashParameters;
use crate::poseidon::traits::{CustomGate, HashFamily, HashParams, Sbox};
...
impl<E: Engine, const RATE: usize, const WIDTH: usize> PoseidonParams<E, RATE, WIDTH> {
    pub fn new(security_level: usize, full_rounds: usize, partial_rounds: usize) -> Self {
        let (params, 
            ...
            super::params::poseidon_light_params::<E, RATE, WIDTH>(security_level, full_rounds, partial_rounds);
        Self {
...
pub fn poseidon_params<E: Engine, const RATE: usize, const WIDTH: usize>(security_level: usize, full_rounds: usize, partial_rounds: usize
...
pub(crate) fn poseidon_light_params<E: Engine, const RATE: usize, const WIDTH: usize>(security_level: usize, full_rounds: usize, partial_rounds: usize) -> (
    InnerHashParameters<E, RATE, WIDTH>,
    u64,
    Vec<[E::Fr; WIDTH]>,
    ([[E::Fr; WIDTH]; WIDTH], Vec<[[E::Fr; WIDTH]; WIDTH]>),
) {
    let (params, alpha) = poseidon_params(security_level, full_rounds, partial_rounds);
