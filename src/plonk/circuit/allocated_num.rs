...
impl<E: Engine> Num<E> {
        ...
        CS: ConstraintSystem<E>,
    {
        if condition.is_constant() {
            let swap = condition
                .get_value()
                .expect("must get a value of the constant");
        ...
        match (condition, a, b) {
            ...
            (Boolean::Is(condition_var), Num::Constant(a), Num::Constant(b)) => {
                ...
                let mut ab_condition_term =
                    ArithmeticTerm::from_variable(condition_var.get_variable());
            ...
            (Boolean::Is(condition_var), Num::Variable(..), Num::Constant(b_const)) => {
                ...
                let ab_condition_term =
                    ArithmeticTerm::from_variable(a_minus_b.get_variable().get_variable())
                        .mul_by_variable(condition_var.get_variable());
    ...
    pub fn mask_by_boolean_into_accumulator<CS: ConstraintSystem<E>>(
        &self,
        cs: &mut CS,
        boolean: &Boolean,
        accumulator: &Self,
        ...
        match (self, accumulator, boolean) {
            (Num::Variable(self_var), Num::Variable(accumulator_var), _) => {
                let accumulated =
                    self_var.mask_by_boolean_into_accumulator(cs, boolean, accumulator_var)?;
            ...
            (
                self_value @ Num::Variable(..),
                accumulator @ Num::Constant(..),
            ...
            (Num::Variable(self_value), Num::Constant(accumulator), Boolean::Is(bit)) => {
                ...
                let self_term = ArithmeticTerm::from_variable(self_value.get_variable())
                    .mul_by_variable(bit.get_variable());
    ...
    pub fn add_two<CS: ConstraintSystem<E>>(
        &self,
        cs: &mut CS,
        first: &Self,
        second: &Self,
    ...
    pub fn fma_with_coefficients<CS: ConstraintSystem<E>>(
        ...
        match (a, b) {
            ...
            (Num::Variable(a_var), Num::Variable(b_var)) => {
                let term = ArithmeticTerm::from_variable_and_coeff(a_var.get_variable(), ab_coeff)
            ...
            (Num::Variable(ref var), Num::Constant(constant)) => {
                match condition_flag {
                    ...
                    Boolean::Is(cond) => {
                        ...
                        let mut main_term = MainGateTerm::<E>::new();
                        let term = ArithmeticTerm::from_variable(cond.get_variable())
                            .mul_by_variable(var.get_variable());
                        main_term.add_assign(term);
                        main_term.sub_assign(ArithmeticTerm::from_variable_and_coeff(
                            cond.get_variable(),
                            *constant,
                        ));
                        main_term.sub_assign(ArithmeticTerm::from_variable(c.get_variable()));
                    ...
                    Boolean::Not(cond) => {
                        ...
                        let term = ArithmeticTerm::from_variable(cond.get_variable())
                            .mul_by_variable(var.get_variable());
                        main_term.sub_assign(term);
                        main_term.add_assign(ArithmeticTerm::from_variable_and_coeff(
                            cond.get_variable(),
                            *constant,
                        ));
                        main_term.sub_assign(ArithmeticTerm::from_variable(c.get_variable()));
            ...
            (&Num::Constant(a), &Num::Constant(b)) => {
                ...
                match condition_flag {
                    ...
                    Boolean::Is(cond) => {
                        ...
                        let mut main_term = MainGateTerm::<E>::new();
                        let term =
                            ArithmeticTerm::from_variable_and_coeff(cond.get_variable(), a_minus_b);
                        main_term.add_assign(term);
                    ...
                    Boolean::Not(cond) => {
                        ...
                        let mut main_term = MainGateTerm::<E>::new();
                        let term =
                            ArithmeticTerm::from_variable_and_coeff(cond.get_variable(), b_minus_a);
                        main_term.add_assign(term);
...
impl<E: Engine> From<Boolean> for Num<E> {
    fn from(b: Boolean) -> Num<E> {
        match b {
            ...
            Boolean::Not(_) => {
                unimplemented!("convertion from Boolean::Not into Num is not supported yet")
            }
        }
    }
}
...
impl<E: Engine> AllocatedNum<E> {
    ...
    pub fn one<CS: ConstraintSystem<E>>(cs: &mut CS) -> Self {
        AllocatedNum {
            ...
            variable: cs
                .get_explicit_one()
                .expect("must get an explicit one from CS"),
        }
    }
    ...
    pub fn zero<CS: ConstraintSystem<E>>(cs: &mut CS) -> Self {
        AllocatedNum {
            ...
            variable: cs
                .get_explicit_zero()
                .expect("must get an explicit zero from CS"),
        }
    }
    ...
    pub fn inverse<CS: ConstraintSystem<E>>(&self, cs: &mut CS) -> Result<Self, SynthesisError> {
        ...
        let self_by_inv =
            ArithmeticTerm::from_variable(self.variable).mul_by_variable(new_allocated.variable);
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        let flag_value_as_field_element =
            flag_value.map(|el| if el { E::Fr::one() } else { E::Fr::zero() });
        ...
        let self_term =
            ArithmeticTerm::from_variable(self.variable).mul_by_variable(flag.get_variable());
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        match condition {
            ...
            Boolean::Is(condition_var) => {
                ...
                let ab_condition_term = ArithmeticTerm::from_variable(a_minus_b.get_variable())
                    .mul_by_variable(condition_var.get_variable());
    ...
    pub fn fma<CS: ConstraintSystem<E>>(
        ...
        let self_term =
            ArithmeticTerm::from_variable(self.get_variable()).mul_by_variable(b.get_variable());
    ...
    pub fn fma_with_coefficients<CS: ConstraintSystem<E>>(
        ...
        let self_term = ArithmeticTerm::from_variable_and_coeff(self.get_variable(), ab_coeff)
            .mul_by_variable(b.get_variable());
    ...
    pub fn mask_by_boolean_into_accumulator<CS: ConstraintSystem<E>>(
        ...
        match boolean {
            ...
            Boolean::Is(bit) => {
                ...
                let self_term = ArithmeticTerm::from_variable(self.get_variable())
                    .mul_by_variable(bit.get_variable());
            ...
            Boolean::Not(not_bit) => {
                ...
                let self_term =
                    ArithmeticTerm::from_variable_and_coeff(self.get_variable(), minus_one)
                        .mul_by_variable(not_bit.get_variable());
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        let self_term =
            ArithmeticTerm::from_variable(self.variable).mul_by_variable(other.variable);
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        let res = match condition {
            ...
            Boolean::Is(cond) => {
                ...
                let mut main_term = MainGateTerm::<E>::new();
                let term = ArithmeticTerm::from_variable(a_minus_b.get_variable())
                    .mul_by_variable(cond.get_variable());
                main_term.add_assign(term);
                main_term.sub_assign(ArithmeticTerm::from_variable(c.get_variable()));
            ...
            Boolean::Not(cond) => {
                ...
                let mut main_term = MainGateTerm::<E>::new();
                let term = ArithmeticTerm::from_variable(b_minus_a.get_variable())
                    .mul_by_variable(cond.get_variable());
                main_term.add_assign(term);
                main_term.sub_assign(ArithmeticTerm::from_variable(c.get_variable()));
        ...
        CS: ConstraintSystem<E>,
    {
        ...
        let res = match condition {
            ...
            Boolean::Is(cond) => {
                ...
                let mut main_term = MainGateTerm::<E>::new();
                let term = ArithmeticTerm::from_variable(a.get_variable())
                    .mul_by_variable(cond.get_variable());
                main_term.add_assign(term);
                main_term.sub_assign(ArithmeticTerm::from_variable(c.get_variable()));
