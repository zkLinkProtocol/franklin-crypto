use crate::poseidon::{common::domain_strategy::DomainStrategy, traits::HashParams};
...
>(
    ...
    match params.hash_family() {
        // crate::poseidon::traits::HashFamily::Rescue => {
        //     crate::rescue::rescue_round_function(params, state)
        // }
        crate::poseidon::traits::HashFamily::Poseidon => {
            crate::poseidon::poseidon_round_function(params, state)
        }
        // crate::poseidon::traits::HashFamily::RescuePrime => {
